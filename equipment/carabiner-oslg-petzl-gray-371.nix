{
  ...
  informasi = {
    nomor_seri = "18D0134774371";
    nama_alat = "Carabiner OSLG PETZL GRAY 371";
  ...
  masa_pakai = {
    tanggal_pembelian = "2024-10-15";
    masa_berlaku_petzl = "tak hingga";
    tanggal_kadaluarsa_rekomendasi = "2034-05-15";
    status_inspeksi = "Lolos";
    tanggal_inspeksi_terakhir = "2025-10-14";
    tanggal_inspeksi_berikutnya = "2026-09-14";
  };

  # Set Atribut: Riwayat Penggunaan
  riwayat = {
    kondisi_alat = "Baik dan mulus";
    total_penggunaan_tercatat = 30; # Nilai integer
    terakhir_digunakan = [
      {
        tanggal = "2025-05-01";
        aktivitas = "Menelusuri Gua Ndilem";
        lokasi = "Panggang";
      }
    ];

    # List (Array) String
    sering_digunakan_untuk = [ "Kebutuhan" "Rescue" "tidak" "digunakan"  ];
  };
  ...
  spesifikasi_teknis = {
    ...
    standar_sertifikasi = [ "CE EN 362 : 2004" "CE EN 12275 : 2013" "UIAA 121 : 2018"];
  };
}
