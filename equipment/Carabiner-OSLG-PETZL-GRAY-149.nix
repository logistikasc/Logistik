{
  ...
  informasi = {
    nomor_seri = "18D0134774149";
    nama_alat = "Carabiner OSLG PETZL GRAY 149";
  ...
  masa_pakai = {
    ...
    tanggal_inspeksi_berikutnya = "2026-9-14";
  };

  # Set Atribut: Riwayat Penggunaan
  riwayat = {
    kondisi_alat = "Baik, tertulis tok ASC dekat Keylock";
    total_penggunaan_tercatat = 30; # Nilai integer
    terakhir_digunakan = [
    ];

    # List (Array) String
    sering_digunakan_untuk = [ "Anchor" "Rescue"  ];
  };
